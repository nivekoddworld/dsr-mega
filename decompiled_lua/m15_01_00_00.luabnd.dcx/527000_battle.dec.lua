...
function OnIf_527000(ai, goal, codeNo)
...
function Griffith527000Battle_Activate(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Griffith527000_Act01(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Griffith527000_Act02(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Griffith527000_Act03(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Griffith527000_Act04(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Griffith527000_Act05(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Griffith527000_Act06(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Griffith527000_Act07(ai, goal)
    goal:AddSubGoal(GOAL_COMMON_Attack, 10, 3011, TARGET_ENE_0, DIST_None, 0)
    
end

function Griffith527000_Act08(ai, goal)
...
function Griffith527000_Act09(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Griffith527000_Act10(ai, goal)
    goal:AddSubGoal(GOAL_COMMON_Attack, 10, 3016, TARGET_ENE_0, DIST_None, 0)
    
end

function Griffith527000_Act11(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Griffith527000_ActAfter_AdjustSpace(ai, goal, paramTbl)
...
function Griffith527000Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function Griffith527000Battle_Terminate(ai, goal)
    
end

function Griffith527000Battle_Interupt(ai, goal)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
