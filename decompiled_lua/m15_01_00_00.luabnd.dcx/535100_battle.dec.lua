...
function Gargoyle_m15_535100Battle_Activate(ai, goal)
...
function Gargoyle_m15_535100_Act01(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function Gargoyle_m15_535100_Act02(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Gargoyle_m15_535100_Act03(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
    if fate <= 30 then
...
function Gargoyle_m15_535100_Act04(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Gargoyle_m15_535100_Act05(ai, goal)
    goal:AddSubGoal(GOAL_COMMON_NonspinningAttack, 10, 3008, TARGET_ENE_0, DIST_Middle, 0, 0)
    
end

function Gargoyle_m15_535100_Act06(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Gargoyle_m15_535100_Act07(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    goal:AddSubGoal(GOAL_COMMON_NonspinningAttack, 10, 3014, TARGET_ENE_0, DIST_Middle, 12, 8)
    
end

function Gargoyle_m15_535100_Act08(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function Gargoyle_m15_535100_Act11(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Gargoyle_m15_535100_Act12(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Gargoyle_m15_535100_Act13(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Gargoyle_m15_535100_Act14(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function Gargoyle_m15_535100_Act15(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Gargoyle_m15_535100_Act16(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Gargoyle_m15_535100_Act17(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Gargoyle_m15_535100_Act18(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Gargoyle_m15_535100_GetWellSpace_Act(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function OnIf_535100(ai, goal, codeNo)
    local canStep713 = 0
    local canStep712 = 0
    local canStep711 = 0
    local canStep701 = 0
...
function Gargoyle_m15_535100Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function Gargoyle_m15_535100Battle_Terminate(ai, goal)
    
end

function Gargoyle_m15_535100Battle_Interupt(ai, goal)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
    local fate3 = ai:GetRandam_Int(1, 100)
    local targetDist = ai:GetDist(TARGET_ENE_0)
