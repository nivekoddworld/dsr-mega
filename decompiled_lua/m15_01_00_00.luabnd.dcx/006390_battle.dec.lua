...
function Laughtrec_Helper6390Battle_Activate(ai, goal)
...
function Laughtrec_Helper6390_Battle_Approach(ai, goal)
...
function Laughtrec_Helper6390_Battle_Normal(ai, goal)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
...
function Laughtrec_Helper6390_Battle_Attack_After(ai, goal)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
    local MoveDist = 3
    if fate <= 50 then
...
function Laughtrec_Helper6390Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function Laughtrec_Helper6390Battle_Terminate(ai, goal)
    
end

function Laughtrec_Helper6390Battle_Interupt(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
