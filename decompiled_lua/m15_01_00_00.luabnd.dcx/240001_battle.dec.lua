REGISTER_GOAL(GOAL_Assassin_shot240001_Battle, "Assassin_shot240001Battle")
...
REGISTER_GOAL_NO_UPDATE(GOAL_Assassin_shot240001_Battle, 1)

function OnIf_240001(ai, goal, codeNo)
...
function Assassin_shot240001Battle_Activate(ai, goal)
    local ObserveNo = 0
    ...
    if ai:HasSpecialEffectId(TARGET_SELF, 5401) and hprate <= 0.5 and ai:IsFinishTimer(1) == true then
        actPerArr[11] = 100
    ...
    actFuncArr[1] = REGIST_FUNC(ai, goal, Assassin_shot240001_Act01)
    actFuncArr[2] = REGIST_FUNC(ai, goal, Assassin_shot240001_Act02)
    defFuncParamTbl[3] = {Att3004_Dist_max, 0, 3004, DIST_Middle}
    actFuncArr[4] = REGIST_FUNC(ai, goal, Assassin_shot240001_Act04)
    actFuncArr[5] = REGIST_FUNC(ai, goal, Assassin_shot240001_Act05)
    defFuncParamTbl[6] = {3011, DIST_Far, nil}
    actFuncArr[7] = REGIST_FUNC(ai, goal, Assassin_shot240001_Act07)
    actFuncArr[9] = REGIST_FUNC(ai, goal, Assassin_shot240001_Act09)
    actFuncArr[10] = REGIST_FUNC(ai, goal, Assassin_shot240001_Act10)
    actFuncArr[11] = REGIST_FUNC(ai, goal, Assassin_shot240001_Act11)
    actFuncArr[12] = REGIST_FUNC(ai, goal, Assassin_shot240001_Act12)
    local atkAfterFunc = REGIST_FUNC(ai, goal, Assassin_shot240001_ActAfter_AdjustSpace, atkAfterOddsTbl)
    Common_Battle_Activate(ai, goal, actPerArr, actFuncArr, atkAfterFunc, defFuncParamTbl)
    
end

function Assassin_shot240001_Act01(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Assassin_shot240001_Act02(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function Assassin_shot240001_Act04(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Assassin_shot240001_Act05(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function Assassin_shot240001_Act07(ai, goal, paramTbl)
    local fate = ai:GetRandam_Int(1, 100)
    if fate <= 40 then
        if ai:HasSpecialEffectId(TARGET_SELF, 5400) then
...
function Assassin_shot240001_Act09(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function Assassin_shot240001_Act10(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function Assassin_shot240001_Act11(ai, goal, paramTbl)
...
function Assassin_shot240001_Act12(ai, goal, paramTbl)
...
function Assassin_shot240001_ActAfter_AdjustSpace(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function Assassin_shot240001Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function Assassin_shot240001Battle_Terminate(ai, goal)
    
end

function Assassin_shot240001Battle_Interupt(ai, goal)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
