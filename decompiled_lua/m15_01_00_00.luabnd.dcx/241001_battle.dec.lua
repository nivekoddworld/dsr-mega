...
function WhiteKnight_Lar_Sw241001Battle_Activate(ai, goal)
    local actPerArr = {}
    local actFuncArr = {}
...
function WhiteKnight_Lar_Sw241001_Act02(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function WhiteKnight_Lar_Sw241001_Act05(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function WhiteKnight_Lar_Sw241001_Act06(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function WhiteKnight_Lar_Sw241001_ActAfter_AdjustSpace(ai, goal, paramTbl)
...
function WhiteKnight_Lar_Sw241001Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function WhiteKnight_Lar_Sw241001Battle_Terminate(ai, goal)
    
end

function WhiteKnight_Lar_Sw241001Battle_Interupt(ai, goal)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
