...
function Giant286000Battle_Activate(ai, goal)
...
function OnIf_286000(ai, goal, codeNo)
    ai:SetEventFlag(11505105, false)
    goal:AddSubGoal(GOAL_COMMON_Wait, 0.5, TARGET_SELF, 0, 0, 0)
    
end

function Giant286000Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function Giant286000Battle_Terminate(ai, goal)
    
end

function Giant286000Battle_Interupt(ai, goal)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
    local fate3 = ai:GetRandam_Int(1, 100)
    local targetDist = ai:GetDist(TARGET_ENE_0)
