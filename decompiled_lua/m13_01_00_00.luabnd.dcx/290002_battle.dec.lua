...
function Sk_Large_Falchion290002Battle_Activate(ai, goal)
    local actPerArr = {}
    local actFuncArr = {}
...
function Sk_Large_Falchion290002_Act01(ai, goal, paramTbl)
...
function Sk_Large_Falchion290002_Act02(ai, goal, paramTbl)
...
function Sk_Large_Falchion290002_Act03(ai, goal, paramTbl)
...
function Sk_Large_Falchion290002_Act06(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function Sk_Large_Falchion290002_ActAfter_AdjustSpace(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Sk_Large_Falchion290002Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function Sk_Large_Falchion290002Battle_Terminate(ai, goal)
    
end

function Sk_Large_Falchion290002Battle_Interupt(ai, goal)
    if ai:IsLadderAct(TARGET_SELF) then
        return false
    end
    local fate = ai:GetRandam_Int(1, 100)
