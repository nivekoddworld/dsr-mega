...
function DragonZombi_m16_342002Battle_Activate(ai, goal)
...
function DragonZombi_m16_342002Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function DragonZombi_m16_342002Battle_Terminate(ai, goal)
    
end

function DragonZombi_m16_342002Battle_Interupt(ai, goal)
    return false
