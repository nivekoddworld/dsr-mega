...
function SanzA6051Battle_Activate(ai, goal)
...
function SanzA6051_Battle_Normal_Attack(ai, goal)
...
function SanzA6051_Battle_Bow(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function SanzA6051_Battle_Sword(ai, goal)
    local fate = ai:GetRandam_Int(1, 100)
...
function SanzA6051_Battle_NormalR_Comb(ai, goal)
...
function SanzA6051_Battle_Kougeki_Noato(ai, goal)
...
function SanzA6051Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function SanzA6051Battle_Terminate(ai, goal)
    
end

function SanzA6051Battle_Interupt(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
    local fate3 = ai:GetRandam_Int(1, 100)
