...
function OnIf_332001(ai, goal, codeNo)
...
function ThreeHaoriBunsin332001Battle_Activate(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
    local fate3 = ai:GetRandam_Int(1, 100)
...
function ThreeHaoriBunsin332001_ActAfter_AdjustSpace(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
    local fate3 = ai:GetRandam_Int(1, 100)
...
function ThreeHaoriBunsin332001StepForLeave(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
    local fate3 = ai:GetRandam_Int(1, 100)
...
function ThreeHaoriBunsin332001Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function ThreeHaoriBunsin332001Battle_Terminate(ai, goal)
    
end

function ThreeHaoriBunsin332001Battle_Interupt(ai, goal)
