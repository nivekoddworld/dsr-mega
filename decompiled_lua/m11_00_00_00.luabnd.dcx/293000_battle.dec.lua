...
function Syarin293000Battle_Activate(ai, goal)
...
function Syarin293000Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function Syarin293000Battle_Terminate(ai, goal)
    
end

function Syarin293000Battle_Interupt(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
