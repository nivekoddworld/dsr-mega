...
function SnowInunezumi120300Battle_Activate(ai, goal)
...
function SnowInunezumi120300Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function SnowInunezumi120300Battle_Terminate(ai, goal)
    
end

function SnowInunezumi120300Battle_Interupt(ai, goal)
