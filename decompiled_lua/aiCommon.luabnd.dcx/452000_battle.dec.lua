...
function OnIf_452000(ai, goal, codeNo)
    if codeNo == 0 then
...
function HolySwordWolf452000Battle_Activate(ai, goal)
    local actPerArr = {}
    local actFuncArr = {}
...
function HolySwordWolf452000_Act01(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function HolySwordWolf452000_Act02(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function HolySwordWolf452000_Act03(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function HolySwordWolf452000_Act04(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function HolySwordWolf452000_Act05(ai, goal, paramTbl)
...
function HolySwordWolf452000_Act06(ai, goal, paramTbl)
...
function HolySwordWolf452000_Act07(ai, goal, paramTbl)
    local hpratePC = ai:GetHpRate(TARGET_LOCALPLAYER)
...
function HolySwordWolf452000_Act08(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function HolySwordWolf452000_Act09(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function HolySwordWolf452000_Act10(ai, goal, paramTbl)
...
function HolySwordWolf452000_Act11(ai, goal, paramTbl)
...
function HolySwordWolf452000_Act12(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function HolySwordWolf452000_Act13(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function HolySwordWolf452000_Act14(ai, goal, paramTbl)
...
function HolySwordWolf452000_Act15(ai, goal, paramTbl)
    local hpratePC = ai:GetHpRate(TARGET_LOCALPLAYER)
...
function HolySwordWolf452000_ActAfter(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function HolySwordWolf452000_ActAfter_AdjustSpace(ai, goal)
    goal:AddSubGoal(GOAL_COMMON_If, 10, 0)
    
end

function HolySwordWolf452000Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function HolySwordWolf452000Battle_Terminate(ai, goal)
    
end

function HolySwordWolf452000Battle_Interupt(ai, goal)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
    local fate3 = ai:GetRandam_Int(1, 100)
    local targetDist = ai:GetDist(TARGET_ENE_0)
