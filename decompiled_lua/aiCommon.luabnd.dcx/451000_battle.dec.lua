...
function OnIf_451000(ai, goal, codeNo)
    if codeNo == 0 then
...
function BlackDragon451000Battle_Activate(ai, goal)
    local actPerArr = {}
    local actFuncArr = {}
...
function BlackDragon451000_Act01(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function BlackDragon451000_Act02(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function BlackDragon451000_Act03(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function BlackDragon451000_Act04(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function BlackDragon451000_Act05(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function BlackDragon451000_Act06(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function BlackDragon451000_Act07(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function BlackDragon451000_Act08(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function BlackDragon451000_Act09(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function BlackDragon451000_Act10(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function BlackDragon451000_Act11(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function BlackDragon451000_Act12(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function BlackDragon451000_Act13(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function BlackDragon451000_Act14(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function BlackDragon451000_Act15(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function BlackDragon451000_Act16(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function BlackDragon451000_Act17(ai, goal, paramTbl)
    goal:AddSubGoal(GOAL_COMMON_If, 10, 1)
    
end

function BlackDragon451000_Turn(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local PARTS_IDX_TAIL = 0
    local tailDmgLv = ai:GetPartsDmg(PARTS_IDX_TAIL)
    local fate = ai:GetRandam_Int(1, 100)
...
function BlackDragon451000_Act18(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local AppDist = 9999
    local DashDist = 9999
    local AttDist = 9999
...
function BlackDragon451000_Act19(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local AppDist = 9999
    local DashDist = 9999
    local AttDist = 9999
...
function BlackDragon451000_Act20(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function BlackDragon451000_ActAfter(ai, goal)
...
function BlackDragon451000_ActAfter_AdjustSpace(ai, goal, paramTbl)
    goal:AddSubGoal(GOAL_COMMON_If, 20, 0)
    
end

function BlackDragon451000Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function BlackDragon451000Battle_Terminate(ai, goal)
    
end

function BlackDragon451000Battle_Interupt(ai, goal)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
