...
function OnIf_347100(ai, goal, codeNo)
    if codeNo == 0 then
...
function GoldenChimera347100Battle_Activate(ai, goal)
    local actPerArr = {}
    local actFuncArr = {}
...
function GoldenChimera347100_Act01(ai, goal, paramTbl)
    local fate = ai:GetRandam_Int(1, 100)
...
function GoldenChimera347100_Act02(ai, goal, paramTbl)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
    local fate3 = ai:GetRandam_Int(1, 100)
...
function GoldenChimera347100_Act03(ai, goal, paramTbl)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
    local fate3 = ai:GetRandam_Int(1, 100)
    local AppDist = Att3000_Dist_max - 1
...
function GoldenChimera347100_Act05(ai, goal, paramTbl)
...
function GoldenChimera347100_Act06(ai, goal, paramTbl)
...
function GoldenChimera347100_Act07(ai, goal, paramTbl)
...
function GoldenChimera347100_Act08(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local PARTS_IDX_TAIL = 0
    local tailDmgLv = ai:GetPartsDmg(PARTS_IDX_TAIL)
    local fate = ai:GetRandam_Int(1, 100)
...
function GoldenChimera347100_Act09(ai, goal, paramTbl)
...
function GoldenChimera347100_Act10(ai, goal, paramTbl)
...
function GoldenChimera347100_Act12(ai, goal, paramTbl)
...
function GoldenChimera347100_Act13(ai, goal, paramTbl)
...
function GoldenChimera347100_Act14(ai, goal, paramTbl)
    local fate = ai:GetRandam_Int(1, 100)
...
function GoldenChimera347100_Act15(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function GoldenChimera347100_Act16(ai, goal, paramTbl)
...
function GoldenChimera347100_Act17(ai, goal, paramTbl)
...
function GoldenChimera347100_ActAfter_AdjustSpace(ai, goal, paramTbl)
    goal:AddSubGoal(GOAL_COMMON_If, 10, 0)
    
end

function GoldenChimera347100_ActAfter_RealTime(ai, goal)
    local fate = ai:GetRandam_Int(1, 100)
...
function GoldenChimera347100_FlyingDecision01(ai, goal)
...
function GoldenChimera347100_FlyingDecision02(ai, goal)
    if ai:IsInsideMsbRegion(TARGET_SELF, AI_DIR_TYPE_F, 25, 1212000) then
...
function GoldenChimera347100_FlyingDecision03(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
    if ai:IsInsideMsbRegion(TARGET_SELF, AI_DIR_TYPE_F, 20, 1212000) then
        if ai:IsInsideMsbRegion(TARGET_SELF, AI_DIR_TYPE_R, 10, 1212000) then
...
function GoldenChimera347100_BackStepDecision01(ai, goal)
    if ai:IsInsideMsbRegion(TARGET_SELF, AI_DIR_TYPE_B, 25, 1212000) then
...
function GoldenChimera347100Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function GoldenChimera347100Battle_Terminate(ai, goal)
    
end

function GoldenChimera347100Battle_Interupt(ai, goal)
