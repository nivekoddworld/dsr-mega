...
function Skeleton_Falchion290000Battle_Activate(ai, goal)
    local actPerArr = {}
    local actFuncArr = {}
...
function Skeleton_Falchion290000_Act01(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Skeleton_Falchion290000_Act02(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function Skeleton_Falchion290000_Act03(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function Skeleton_Falchion290000_Act04(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function Skeleton_Falchion290000_Act06(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function Skeleton_Falchion290000_ActAfter_AdjustSpace(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Skeleton_Falchion290000Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function Skeleton_Falchion290000Battle_Terminate(ai, goal)
    
end

function Skeleton_Falchion290000Battle_Interupt(ai, goal)
    if ai:IsLadderAct(TARGET_SELF) then
        return false
    end
    local fate = ai:GetRandam_Int(1, 100)
