...
function ArmoredTask_BackGuard346100Battle_Activate(ai, goal)
...
function ArmoredTask_BackGuard346100_ActAfter_AdjustSpace(ai, goal)
...
function ArmoredTask_BackGuard346100Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function ArmoredTask_BackGuard346100Battle_Terminate(ai, goal)
    
end

function ArmoredTask_BackGuard346100Battle_Interupt(ai, goal)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
    local fate3 = ai:GetRandam_Int(1, 100)
    local targetDist = ai:GetDist(TARGET_ENE_0)
