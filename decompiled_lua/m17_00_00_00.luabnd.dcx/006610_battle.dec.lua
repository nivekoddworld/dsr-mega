REGISTER_GOAL(GOAL_CrystalKnight6610_Battle, "CrystalKnight6610Battle")
local NormalR_min = 0
...
REGISTER_GOAL_NO_UPDATE(GOAL_CrystalKnight6610_Battle, 1)

function CrystalKnight6610Battle_Activate(ai, goal)
    local actPerArr = {}
    local actFuncArr = {}
    ...
    actFuncArr[1] = REGIST_FUNC(ai, goal, CrystalKnight6610_Act01)
    actFuncArr[2] = REGIST_FUNC(ai, goal, CrystalKnight6610_Act02)
    actFuncArr[3] = REGIST_FUNC(ai, goal, CrystalKnight6610_Act03)
    actFuncArr[4] = REGIST_FUNC(ai, goal, CrystalKnight6610_Act04)
    actFuncArr[5] = REGIST_FUNC(ai, goal, CrystalKnight6610_Act05)
    actFuncArr[6] = REGIST_FUNC(ai, goal, CrystalKnight6610_Act06)
    actFuncArr[7] = REGIST_FUNC(ai, goal, CrystalKnight6610_Act07)
    actFuncArr[8] = REGIST_FUNC(ai, goal, CrystalKnight6610_Act08)
    actFuncArr[9] = REGIST_FUNC(ai, goal, CrystalKnight6610_Act09)
    local atkAfterFunc = REGIST_FUNC(ai, goal, CrystalKnight6610_ActAfter_AdjustSpace, atkAfterOddsTbl)
    Common_Battle_Activate(ai, goal, actPerArr, actFuncArr, atkAfterFunc, defFuncParamTbl)
    
end

function CrystalKnight6610_Act01(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function CrystalKnight6610_Act02(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function CrystalKnight6610_Act03(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function CrystalKnight6610_Act04(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function CrystalKnight6610_Act05(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
    local AppDist = NormalR_max
    local DashDist = NormalR_max + 5
...
function CrystalKnight6610_Act06(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function CrystalKnight6610_Act07(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
    CommonNPC_ChangeWepL1(ai, goal)
...
function CrystalKnight6610_Act08(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function CrystalKnight6610_Act09(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function CrystalKnight6610_ActAfter_AdjustSpace(ai, goal, paramTbl)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
    local MoveDist = 3
    if fate <= 5 then
...
function CrystalKnight6610Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function CrystalKnight6610Battle_Terminate(ai, goal)
    
end

function CrystalKnight6610Battle_Interupt(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
