...
function Pisaca_Sisters333001Battle_Activate(ai, goal)
...
function Find_far_Point(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Pisaca_Sisters333001Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function Pisaca_Sisters333001Battle_Terminate(ai, goal)
    
end

function Pisaca_Sisters333001Battle_Interupt(ai, goal)
    return false
