...
function OnIf_225000(ai, goal, codeNo)
...
function Hammer_m10_225000Battle_Activate(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local Act01Per = 0
    local Act02Per = 0
    local Act03Per = 0
...
function Hammer_m10_225000_Act01(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function Hammer_m10_225000_Act02(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function Hammer_m10_225000_Act03(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
...
function Hammer_m10_225000_Act04(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function Hammer_m10_225000_Act05(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function Hammer_m10_225000_Act06(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function Hammer_m10_225000_Act07(ai, goal)
...
function Hammer_m10_225000_Act08(ai, goal)
...
function Hammer_m10_225000_Act09(ai, goal)
    ai:SetEventMoveTarget(1012741)
...
function Hammer_m10_225000_GetWellSpace_Act(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
    if fate <= 30 then
...
function Hammer_m10_225000Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function Hammer_m10_225000Battle_Terminate(ai, goal)
    
end

function Hammer_m10_225000Battle_Interupt(ai, goal)
    return false
