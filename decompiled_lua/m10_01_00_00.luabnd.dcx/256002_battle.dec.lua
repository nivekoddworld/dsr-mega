...
function OnIf_256002(ai, goal, codeNo)
...
function LightKnight_Rapier256002Battle_Activate(ai, goal)
    local ObserveNo = 0
...
function LightKnight_Rapier256002Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function LightKnight_Rapier256002Battle_Terminate(ai, goal)
    
end

function LightKnight_Rapier256002Battle_Interupt(ai, goal)
    if ai:IsLadderAct(TARGET_SELF) then
        return false
    end
    local fate = ai:GetRandam_Int(1, 100)
