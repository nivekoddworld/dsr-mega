...
function Gargoyle535000Battle_Activate(ai, goal)
...
function Gargoyle535000_Act01(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function Gargoyle535000_Act02(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Gargoyle535000_Act03(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
    if fate <= 30 then
...
function Gargoyle535000_Act04(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Gargoyle535000_Act11(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Gargoyle535000_Act12(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Gargoyle535000_Act13(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Gargoyle535000_Act14(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function Gargoyle535000_Act15(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Gargoyle535000_Act16(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Gargoyle535000_Act17(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Gargoyle535000_Act18(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local AppDist = Att3026_Dist_max
    local DashDist = Att3026_Dist_max + 2
    local Odds_Guard = 0
...
function Gargoyle535000_Act19(ai, goal)
    goal:AddSubGoal(GOAL_COMMON_SpinStep, 10, 701, TARGET_ENE_0, 0, AI_DIR_TYPE_B, 3.5)
    
end

function Gargoyle535000_GetWellSpace_Act(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function OnIf_535000(ai, goal, codeNo)
    local canStep713 = 0
    local canStep712 = 0
    local canStep711 = 0
    local canStep701 = 0
...
function Gargoyle535000Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function Gargoyle535000Battle_Terminate(ai, goal)
    
end

function Gargoyle535000Battle_Interupt(ai, goal)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
    local fate3 = ai:GetRandam_Int(1, 100)
    local targetDist = ai:GetDist(TARGET_ENE_0)
