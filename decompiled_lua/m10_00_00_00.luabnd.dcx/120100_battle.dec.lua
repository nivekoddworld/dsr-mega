REGISTER_GOAL(GOAL_SmallInunezumi120100_Battle, "SmallInunezumi120100Battle")
...
REGISTER_GOAL_NO_UPDATE(GOAL_SmallInunezumi120100_Battle, 1)

function SmallInunezumi120100Battle_Activate(ai, goal)
    ...
    if not (fateGWS <= GetWellSpace_Odds) or fate2 <= 80 then
    else
...
function SmallInunezumi120100Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function SmallInunezumi120100Battle_Terminate(ai, goal)
    
end

function SmallInunezumi120100Battle_Interupt(ai, goal)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
    local fate3 = ai:GetRandam_Int(1, 100)
    local targetDist = ai:GetDist(TARGET_ENE_0)
