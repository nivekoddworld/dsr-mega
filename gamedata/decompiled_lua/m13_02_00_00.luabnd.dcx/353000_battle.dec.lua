...
function OnIf_353000(ai, goal, codeNo)
...
function LakeBeast353000Battle_Activate(ai, goal)
...
function LakeBeast353000_Act08(ai, goal)
    goal:AddSubGoal(GOAL_COMMON_AttackTunableSpin, 20, 3005, TARGET_ENE_0, 45, -1, 20)
    
end

function LakeBeast353000_Act09(ai, goal)
    goal:AddSubGoal(GOAL_COMMON_NonspinningAttack, 10, 3006, TARGET_ENE_0, 45)
    
end

function LakeBeast353000_Act10(ai, goal)
    goal:AddSubGoal(GOAL_COMMON_NonspinningAttack, 10, 3007, TARGET_ENE_0, 45)
    
end

function LakeBeast353000_Act11(ai, goal)
    goal:AddSubGoal(GOAL_COMMON_AttackTunableSpin, 10, 3008, TARGET_ENE_0, 70, -1, 20)
    
end

function LakeBeast353000Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function LakeBeast353000Battle_Terminate(ai, goal)
    
end

function LakeBeast353000Battle_Interupt(ai, goal)
