...
function BlackKnight_Spear279003Battle_Activate(ai, goal)
    local actPerArr = {}
    local actFuncArr = {}
...
function BlackKnight_Spear279003_Act02(ai, goal, paramTbl)
...
function BlackKnight_Spear279003_Act05(ai, goal, paramTbl)
...
function BlackKnight_Spear279003_Act06(ai, goal, paramTbl)
...
function BlackKnight_Spear279003_Act07(ai, goal, paramTbl)
...
function BlackKnight_Spear279003_Act08(ai, goal, paramTbl)
...
function BlackKnight_Spear279003_ActAfter_AdjustSpace(ai, goal, paramTbl)
...
function BlackKnight_Spear279003Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function BlackKnight_Spear279003Battle_Terminate(ai, goal)
    
end

function BlackKnight_Spear279003Battle_Interupt(ai, goal)
    local fate = ai:GetRandam_Int(1, 100)
