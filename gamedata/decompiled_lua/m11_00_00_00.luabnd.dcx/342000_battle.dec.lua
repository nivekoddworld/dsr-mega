...
function DragonZombi342000Battle_Activate(ai, goal)
...
function DragonZombi342000Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function DragonZombi342000Battle_Terminate(ai, goal)
    
end

function DragonZombi342000Battle_Interupt(ai, goal)
    return false
