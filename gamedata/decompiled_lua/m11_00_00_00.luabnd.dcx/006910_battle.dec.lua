...
function FUSHI6910Battle_Activate(ai, goal)
    local hprate = ai:GetHpRate(TARGET_SELF)
    FUSHI6910_Battle_Sword(ai, goal)
    
end

function FUSHI6910_Gitai_Move(ai, goal)
    goal:AddSubGoal(GOAL_COMMON_ApproachTarget, 5, TARGET_ENE_0, 2, TARGET_SELF, false, -1)
    
end

function FUSHI6910_Battle_Sword(ai, goal)
...
function FUSHI6910_Battle_NormalR_Comb(ai, goal)
    local NR_fate = ai:GetRandam_Int(1, 100)
...
function FUSHI6910_Battle_Kougeki_Noato(ai, goal)
...
function FUSHI6910Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function FUSHI6910Battle_Terminate(ai, goal)
    
end

function FUSHI6910Battle_Interupt(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
