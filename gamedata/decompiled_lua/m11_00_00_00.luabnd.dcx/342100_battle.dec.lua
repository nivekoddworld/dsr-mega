...
function DraZonbiLegs342100Battle_Activate(ai, goal)
...
function DraZonbiLegs342100_Act00(ai, goal)
    local fate = ai:GetRandam_Int(1, 100)
...
function DraZonbiLegs342100_Act07(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function DraZonbiLegs342100_Act08(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function DraZonbiLegs342100_Act09(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function DraZonbiLegs342100_GetWellSpace_Act(ai, goal)
    local fate = ai:GetRandam_Int(1, 100)
...
function DraZonbiLegs342100Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function DraZonbiLegs342100Battle_Terminate(ai, goal)
    
end

function DraZonbiLegs342100Battle_Interupt(ai, goal)
    return false
