...
function Heroine273000Battle_Activate(ai, goal)
    local actPerArr = {}
    local actFuncArr = {}
...
function Heroine273000_Act02(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Heroine273000_Act03(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Heroine273000_Act04(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Heroine273000_Act05(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Heroine273000_Act06(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Heroine273000_Act07(ai, goal, paramTbl)
    local flag = ai:GetNumber(0)
...
function Heroine273000_Act08(ai, goal, paramTbl)
...
function Heroine273000Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function Heroine273000Battle_Terminate(ai, goal)
    
end

function Heroine273000Battle_Interupt(ai, goal)
