...
function Kyochojin231000Battle_Activate(ai, goal)
...
function Kyochojin231000Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function Kyochojin231000Battle_Terminate(ai, goal)
    
end

function Kyochojin231000Battle_Interupt(ai, goal)
