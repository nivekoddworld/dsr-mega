REGISTER_GOAL(GOAL_blackDog334000_Battle, "blackDog334000Battle")
...
REGISTER_GOAL_NO_UPDATE(GOAL_blackDog334000_Battle, 1)

function blackDog334000Battle_Activate(ai, goal)
    local actPerArr = {}
    local actFuncArr = {}
    ...
    actFuncArr[1] = REGIST_FUNC(ai, goal, blackDog334000_Act01)
    actFuncArr[2] = REGIST_FUNC(ai, goal, blackDog334000_Act02)
    actFuncArr[3] = REGIST_FUNC(ai, goal, blackDog334000_Act03)
    actFuncArr[4] = REGIST_FUNC(ai, goal, blackDog334000_Act04)
    local atkAfterFunc = REGIST_FUNC(ai, goal, blackDog334000_ActAfter_AdjustSpace)
    Common_Battle_Activate(ai, goal, actPerArr, actFuncArr, atkAfterFunc, defFuncParamTbl)
    
end

function blackDog334000_Act01(ai, goal)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
...
function blackDog334000_Act02(ai, goal)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
    local bRight = ai:GetRandam_Int(0, 1)
    local RTime = ai:GetRandam_Int(0.7, 1.7)
...
function blackDog334000_Act03(ai, goal)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
    local bRight = ai:GetRandam_Int(0, 1)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function blackDog334000_Act04(ai, goal)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
    if fate <= 50 then
...
function blackDog334000_ActAfter_AdjustSpace(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
    if fate <= 30 then
...
function blackDog334000Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function blackDog334000Battle_Terminate(ai, goal)
    
end

function blackDog334000Battle_Interupt(ai, goal)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
    local fate3 = ai:GetRandam_Int(1, 100)
    local targetDist = ai:GetDist(TARGET_ENE_0)
