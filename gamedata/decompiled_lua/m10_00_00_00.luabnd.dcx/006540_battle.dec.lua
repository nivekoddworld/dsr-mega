...
function SunKnight6540Battle_Activate(ai, goal)
    ...
    local MoveArea1 = 0
    local MoveArea2 = 0
    if myThinkId == 6540 then
        PointFrontOfWall = 1012997
    elseif myThinkId == 6541 then
        PointFrontOfWall = 1002997
    elseif myThinkId == 6542 then
        PointFrontOfWall = 1412897
    elseif myThinkId == 6543 then
        PointFrontOfWall = 1512997
        MoveArea1 = 1512995
        MoveArea2 = 1512995
    elseif myThinkId == 6544 then
    ...
    elseif MoveArea1 ~= 0 and (not (ai:IsInsideTargetRegion(TARGET_LOCALPLAYER, MoveArea1) or ai:IsInsideTargetRegion(TARGET_LOCALPLAYER, MoveArea2))) then
...
function SunKnight6540_Battle(ai, goal)
    ...
    if targetDist >= 8 then
        actPerArr[1] = 5
        actPerArr[3] = 5
        actPerArr[5] = 45 * MagicValue
        actPerArr[7] = 40
        actPerArr[10] = 5
    elseif targetDist >= 5 then
        actPerArr[1] = 15
        actPerArr[3] = 15
        actPerArr[5] = 35 * MagicValue
        actPerArr[7] = 30
        actPerArr[10] = 5
