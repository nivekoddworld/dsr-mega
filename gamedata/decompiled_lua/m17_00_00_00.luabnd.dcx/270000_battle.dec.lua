...
function HebibitoB270000Battle_Activate(ai, goal)
    local actPerArr = {}
    local actFuncArr = {}
...
function HebibitoB270000_Act04(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function HebibitoB270000_Act05(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function HebibitoB270000_Act07(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function HebibitoB270000_Act09(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function HebibitoB270000Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function HebibitoB270000Battle_Terminate(ai, goal)
    
end

function HebibitoB270000Battle_Interupt(ai, goal)
    if ai:IsLadderAct(TARGET_SELF) then
        return false
    end
