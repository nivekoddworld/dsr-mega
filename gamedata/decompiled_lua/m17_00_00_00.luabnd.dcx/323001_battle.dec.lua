...
function Kagerou_m17_323001Battle_Activate(ai, goal)
...
function Kagerou_m17_323001Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function Kagerou_m17_323001Battle_Terminate(ai, goal)
    
end

function Kagerou_m17_323001Battle_Interupt(ai, goal)
    return false
