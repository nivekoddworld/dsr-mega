...
function Crystal271000Battle_Activate(ai, goal)
    local actPerArr = {}
    local actFuncArr = {}
...
function Crystal271000_Act01(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Crystal271000_Act04(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function Crystal271000_Act05(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function Crystal271000_Act06(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function Crystal271000_Act07(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function Crystal271000_ActAfter_AdjustSpace(ai, goal, paramTbl)
...
function Crystal271000Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function Crystal271000Battle_Terminate(ai, goal)
    
end

function Crystal271000Battle_Interupt(ai, goal)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
