...
function OnIf_417200(ai, goal, codeNo)
    if codeNo == 0 then
        ai:SetTimer(0, 25)
    end
    if codeNo == 1 then
...
function HumanityL417200Battle_Activate(ai, goal)
    local actPerArr = {}
    local actFuncArr = {}
...
function HumanityL417200_Act01(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function HumanityL417200_Act03(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function HumanityL417200_Act04(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function HumanityL417200_Act05(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function HumanityL417200_Act06(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function HumanityL417200_Act07(ai, goal, paramTbl)
...
function HumanityL417200_Act08(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function HumanityL417200_Act09(ai, goal, paramTbl)
...
function HumanityL417200_Act10(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local AttDist = 3
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
...
function HumanityL417200_Act11(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local AttDist = 8
    local fate = ai:GetRandam_Int(1, 100)
...
function HumanityL417200_Act12(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local hprate = ai:GetHpRate(TARGET_SELF)
    local AttDist = 20
    local fate = ai:GetRandam_Int(1, 100)
...
function HumanityL417200_ActAfter(ai, goal)
...
function HumanityL417200_ActAfter_AdjustSpace(ai, goal, paramTbl)
    goal:AddSubGoal(GOAL_COMMON_If, 10, 2)
    
end

function HumanityL417200Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function HumanityL417200Battle_Terminate(ai, goal)
    
end

function HumanityL417200Battle_Interupt(ai, goal)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
