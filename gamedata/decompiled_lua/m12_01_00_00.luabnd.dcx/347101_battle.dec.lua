...
function OnIf_347101(ai, goal, codeNo)
    if codeNo == 0 then
...
function GoldenChimera347101Battle_Activate(ai, goal)
    local actPerArr = {}
    local actFuncArr = {}
    ...
    elseif ai:GetTeamOrder(ORDER_TYPE_Role) == ROLE_TYPE_Torimaki then
        ...
        elseif ai:GetNumber(3) == 1 then
            Act14Per = 100
        elseif ai:IsInsideTarget(TARGET_FRI_0, AI_DIR_TYPE_F, 9.5) and friendDist <= 30 or ai:IsInsideTarget(TARGET_FRI_0, AI_DIR_TYPE_F, 11.4) and friendDist <= 25 or ai:IsInsideTarget(TARGET_FRI_0, AI_DIR_TYPE_F, 14.3) and friendDist <= 20 or ai:IsInsideTarget(TARGET_FRI_0, AI_DIR_TYPE_F, 18.9) and friendDist <= 15 or ai:IsInsideTarget(TARGET_FRI_0, AI_DIR_TYPE_F, 28.1) and friendDist <= 10 then
            Act18Per = 100
        elseif ai:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_R, 150) and targetDist <= 3 then
            Act02Per = 100
        elseif ai:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_L, 150) and targetDist <= 3 then
...
function GoldenChimera347101_Act01(ai, goal, paramTbl)
    local fate = ai:GetRandam_Int(1, 100)
...
function GoldenChimera347101_Act02(ai, goal, paramTbl)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
    local fate3 = ai:GetRandam_Int(1, 100)
...
function GoldenChimera347101_Act03(ai, goal, paramTbl)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
    local fate3 = ai:GetRandam_Int(1, 100)
    local AppDist = Att3000_Dist_max - 1
...
function GoldenChimera347101_Act05(ai, goal, paramTbl)
...
function GoldenChimera347101_Act06(ai, goal, paramTbl)
...
function GoldenChimera347101_Act07(ai, goal, paramTbl)
...
function GoldenChimera347101_Act08(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local PARTS_IDX_TAIL = 0
    local tailDmgLv = ai:GetPartsDmg(PARTS_IDX_TAIL)
    local fate = ai:GetRandam_Int(1, 100)
    ...
    elseif ai:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_B, 30) and targetDist <= 2 and fate <= 50 then
...
function GoldenChimera347101_Act09(ai, goal, paramTbl)
...
function GoldenChimera347101_Act10(ai, goal, paramTbl)
...
function GoldenChimera347101_Act12(ai, goal, paramTbl)
...
function GoldenChimera347101_Act13(ai, goal, paramTbl)
...
function GoldenChimera347101_Act14(ai, goal, paramTbl)
    local fate = ai:GetRandam_Int(1, 100)
...
function GoldenChimera347101_Act15(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function GoldenChimera347101_Act16(ai, goal, paramTbl)
...
function GoldenChimera347101_Act17(ai, goal, paramTbl)
...
function GoldenChimera347101_Act18(ai, goal, paramTbl)
    local fate = ai:GetRandam_Int(1, 100)
    if ai:IsInsideMsbRegion(TARGET_SELF, AI_DIR_TYPE_F, 10, 1212000) then
...
function GoldenChimera347101_Act19(ai, goal, paramTbl)
    local fate = ai:GetRandam_Int(1, 100)
...
function GoldenChimera347101_ActAfter_AdjustSpace(ai, goal, paramTbl)
    goal:AddSubGoal(GOAL_COMMON_If, 10, 0)
    
end

function GoldenChimera347101_ActAfter_RealTime(ai, goal)
    local fate = ai:GetRandam_Int(1, 100)
...
function GoldenChimera347101_SideWalk(ai, goal)
    local fate = ai:GetRandam_Int(1, 100)
    if ai:GetTeamOrder(ORDER_TYPE_Role) == ROLE_TYPE_Attack then
        if fate <= 50 then
            goal:AddSubGoal(GOAL_COMMON_SidewayMove, 5, TARGET_ENE_0, ai:GetRandam_Int(0, 1), ai:GetRandam_Int(30, 45), true, true, -1)
    ...
    elseif ai:GetTeamOrder(ORDER_TYPE_Role) == ROLE_TYPE_Torimaki then
        if fate <= 100 then
            goal:AddSubGoal(GOAL_COMMON_SidewayMove, 7.5, TARGET_ENE_0, ai:GetRandam_Int(0, 1), ai:GetRandam_Int(45, 60), true, true, -1)
        end
    elseif ai:GetTeamOrder(ORDER_TYPE_Role) == ROLE_TYPE_Kankyaku and fate <= 100 then
        goal:AddSubGoal(GOAL_COMMON_SidewayMove, 10, TARGET_ENE_0, ai:GetRandam_Int(0, 1), ai:GetRandam_Int(60, 75), true, true, -1)
    end
    
end

function GoldenChimera347101_FlyingDecision01(ai, goal)
    local GetWellSpace_Odds = 0
...
function GoldenChimera347101_FlyingDecision02(ai, goal)
    local GetWellSpace_Odds = 0
    if ai:IsInsideMsbRegion(TARGET_SELF, AI_DIR_TYPE_F, 25, 1212000) then
...
function GoldenChimera347101_FlyingDecision03(ai, goal)
    local GetWellSpace_Odds = 0
    local fate = ai:GetRandam_Int(1, 100)
    if ai:IsInsideMsbRegion(TARGET_SELF, AI_DIR_TYPE_F, 20, 1212000) then
        if ai:IsInsideMsbRegion(TARGET_SELF, AI_DIR_TYPE_R, 10, 1212000) then
...
function GoldenChimera347101_BackStepDecision01(ai, goal)
    local GetWellSpace_Odds = 0
    if ai:IsInsideMsbRegion(TARGET_SELF, AI_DIR_TYPE_B, 25, 1212000) then
...
function GoldenChimera347100_ChargeDecision01(ai, goal)
    local fate = ai:GetRandam_Int(1, 100)
...
function GoldenChimera347101Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function GoldenChimera347101Battle_Terminate(ai, goal)
    
end

function GoldenChimera347101Battle_Interupt(ai, goal)
