...
function OnIf_256001(ai, goal, codeNo)
...
function LightKnight_Bow256001Battle_Activate(ai, goal)
...
function LightKnight_Bow256001Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function LightKnight_Bow256001Battle_Terminate(ai, goal)
    
end

function LightKnight_Bow256001Battle_Interupt(ai, goal)
