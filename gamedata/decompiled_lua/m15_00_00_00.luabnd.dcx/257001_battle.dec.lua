...
function OnIf_257001(ai, goal, codeNo)
...
function HeavyKnight_Mace257001Battle_Activate(ai, goal)
    local actPerArr = {}
    local actFuncArr = {}
    ...
    local f2_local0 = {100, 80, 10, 10, 0, 0}
    local atkAfterFunc = REGIST_FUNC(ai, goal, HumanCommon_ActAfter_AdjustSpace, f2_local0)
    Common_Battle_Activate(ai, goal, actPerArr, actFuncArr, atkAfterFunc, defFuncParamTbl)
    
end

function HeavyKnight_Mace257001_Act01(ai, goal, paramTbl)
...
function HeavyKnight_Mace257001_Act02(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function HeavyKnight_Mace257001_Act03(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function HeavyKnight_Mace257001_Act04(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function HeavyKnight_Mace257001_Act05(ai, goal, paramTbl)
    local fate = ai:GetRandam_Int(1, 100)
...
function HeavyKnight_Mace257001_Act06(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
    local AppDist = Att3007_Dist_max
    local DashDist = Att3007_Dist_max + 2
...
function HeavyKnight_Mace257001_Act07(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function HeavyKnight_Mace257001_Act09(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
    local AppDist = Att3000_Dist_max
    local DashDist = Att3000_Dist_max + 2
...
function HeavyKnight_Mace257001Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function HeavyKnight_Mace257001Battle_Terminate(ai, goal)
    
end

function HeavyKnight_Mace257001Battle_Interupt(ai, goal)
    local fate = ai:GetRandam_Int(1, 100)
