...
function LargeCat536000Battle_Activate(ai, goal)
    local actPerArr = {}
    local actFuncArr = {}
    ...
    if not (ai:IsInsideTargetRegion(TARGET_ENE_0, 1202730) or ai:IsInsideTargetRegion(TARGET_ENE_0, 1202731)) then
        actPerArr[11] = 100
    else
...
function LargeCat536000_Act01(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function LargeCat536000_Act02(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function LargeCat536000_Act03(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function LargeCat536000_Act04(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function LargeCat536000_Act05(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function LargeCat536000_Act06(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function LargeCat536000_Act07(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function LargeCat536000_Act08(ai, goal, paramTbl)
...
function LargeCat536000_Act09(ai, goal, paramTbl)
...
function LargeCat536000_Act10(ai, goal, paramTbl)
    ai:SetTimer(0, 15)
    goal:AddSubGoal(GOAL_COMMON_SpinStep, 5, 701, TARGET_ENE_0, 0, AI_DIR_TYPE_B, 9)
    
end

function LargeCat536000_Act11(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function LargeCat536000_ActAfter_AdjustSpace(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function LargeCat536000Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function LargeCat536000Battle_Terminate(ai, goal)
    
end

function LargeCat536000Battle_Interupt(ai, goal)
    local fate = ai:GetRandam_Int(1, 100)
