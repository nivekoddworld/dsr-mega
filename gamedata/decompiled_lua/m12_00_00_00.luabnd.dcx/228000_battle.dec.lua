...
function KinokoChild228000Battle_Activate(ai, goal)
...
function KinokoChild228000Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function KinokoChild228000Battle_Terminate(ai, goal)
    
end

function KinokoChild228000Battle_Interupt(ai, goal)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
    local fate3 = ai:GetRandam_Int(1, 100)
    local targetDist = ai:GetDist(TARGET_ENE_0)
