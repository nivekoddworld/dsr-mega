...
function Kinobori337000Battle_Activate(ai, goal)
    ...
    if ai:HasSpecialEffectId(TARGET_SELF, 5111) then
        ...
        if not (fateGWS <= GetWellSpace_Odds) or fate2 <= 60 then
...
function Kinobori337000Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function Kinobori337000Battle_Terminate(ai, goal)
    
end

function Kinobori337000Battle_Interupt(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
