...
function SanzB6052Battle_Activate(ai, goal)
...
function SanzB6052_Battle_Sword(ai, goal)
...
function SanzB6052_Battle_Magic(ai, goal)
...
function SanzB6052_Battle_NormalR_Comb(ai, goal)
...
function SanzB6052_Battle_Kougeki_Noato(ai, goal)
...
function SanzB6052Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function SanzB6052Battle_Terminate(ai, goal)
    
end

function SanzB6052Battle_Interupt(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
