...
function OnIf_323000(ai, goal, codeNo)
...
function Kagerou323000Battle_Activate(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    ...
    if ai:IsInsideTargetRegion(TARGET_SELF, 1202210) then
        Act04Per = 100
    elseif ai:IsFinishTimer(0) and (not (FirstImpression ~= 1 or ai:IsInsideTargetRegion(TARGET_SELF, 1202226))) or hprate <= ai:GetNumber(1) - 0.2 and ai:IsFinishTimer(1) and FirstImpression == 1 and not ai:IsInsideTargetRegion(TARGET_SELF, 1202226) then
        Act03Per = 100
...
function Kagerou323000Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function Kagerou323000Battle_Terminate(ai, goal)
    
end

function Kagerou323000Battle_Interupt(ai, goal)
    return false
