...
function wyvern352000Battle_Activate(ai, goal)
...
function wyvern352000_ActAfter_AdjustSpace(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
    local fate3 = ai:GetRandam_Int(1, 100)
...
function wyvern352000Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function wyvern352000Battle_Terminate(ai, goal)
    
end

function wyvern352000Battle_Interupt(ai, goal)
    return false
