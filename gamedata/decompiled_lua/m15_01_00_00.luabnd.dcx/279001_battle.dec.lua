REGISTER_GOAL(GOAL_BlackKnight_Lar_Sw279001_Battle, "BlackKnight_Lar_Sw279001Battle")
...
local Att3013_Dist_max = 3
local Att3014_Dist_min = 0
local Att3014_Dist_max = 3
REGISTER_GOAL_NO_UPDATE(GOAL_BlackKnight_Lar_Sw279001_Battle, 1)

function BlackKnight_Lar_Sw279001Battle_Activate(ai, goal)
    local actPerArr = {}
    local actFuncArr = {}
    ...
    actFuncArr[1] = REGIST_FUNC(ai, goal, BlackKnight_Lar_Sw279001_Act01)
    actFuncArr[2] = REGIST_FUNC(ai, goal, BlackKnight_Lar_Sw279001_Act02)
    defFuncParamTbl[3] = {Att3011_Dist_max, 75, 3011, DIST_Middle}
    actFuncArr[4] = REGIST_FUNC(ai, goal, BlackKnight_Lar_Sw279001_Act04)
    actFuncArr[5] = REGIST_FUNC(ai, goal, BlackKnight_Lar_Sw279001_Act05)
    actFuncArr[6] = REGIST_FUNC(ai, goal, BlackKnight_Lar_Sw279001_Act06)
    actFuncArr[7] = REGIST_FUNC(ai, goal, BlackKnight_Lar_Sw279001_Act07)
    actFuncArr[8] = REGIST_FUNC(ai, goal, BlackKnight_Lar_Sw279001_Act08)
    local atkAfterFunc = REGIST_FUNC(ai, goal, BlackKnight_Lar_Sw279001_ActAfter_AdjustSpace)
    Common_Battle_Activate(ai, goal, actPerArr, actFuncArr, atkAfterFunc, defFuncParamTbl)
    
end

function BlackKnight_Lar_Sw279001_Act01(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function BlackKnight_Lar_Sw279001_Act02(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function BlackKnight_Lar_Sw279001_Act04(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function BlackKnight_Lar_Sw279001_Act05(ai, goal, paramTbl)
...
function BlackKnight_Lar_Sw279001_Act06(ai, goal, paramTbl)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
...
function BlackKnight_Lar_Sw279001_Act07(ai, goal, paramTbl)
...
function BlackKnight_Lar_Sw279001_Act08(ai, goal, paramTbl)
    local AppDist = Att3014_Dist_max
    local DashDist = Att3014_Dist_max + 2
    local Odds_Guard = 75
    Approach_Act(ai, goal, AppDist, DashDist, Odds_Guard)
...
function BlackKnight_Lar_Sw279001_ActAfter_AdjustSpace(ai, goal, paramTbl)
...
function BlackKnight_Lar_Sw279001Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function BlackKnight_Lar_Sw279001Battle_Terminate(ai, goal)
    
end

function BlackKnight_Lar_Sw279001Battle_Interupt(ai, goal)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
    ...
    if UseItem_Act(ai, goal, distUseItem_Act, oddsUseItem_Act) then
        if targetDist <= 6.4 then
            ...
            goal:AddSubGoal(GOAL_COMMON_Attack, 10, 3005, TARGET_ENE_0, DIST_Middle, 0)
        elseif not (ai:IsRideEdgeFlag(TARGET_SELF) or ai:IsRideEdgeFlag(TARGET_ENE_0)) then
