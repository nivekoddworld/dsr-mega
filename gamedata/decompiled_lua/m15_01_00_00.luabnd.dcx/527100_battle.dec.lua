...
function Griffith_large527100Battle_Activate(ai, goal)
...
function Griffith_large527100_Act01(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Griffith_large527100_Act02(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Griffith_large527100_Act03(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Griffith_large527100_Act04(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Griffith_large527100_Act05(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Griffith_large527100_Act06(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Griffith_large527100_Act07(ai, goal)
    goal:AddSubGoal(GOAL_COMMON_Attack, 10, 3011, TARGET_ENE_0, DIST_None, 0)
    
end

function Griffith_large527100_Act08(ai, goal)
...
function Griffith_large527100_Act09(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Griffith_large527100_Act10(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Griffith_large527100_Act11(ai, goal)
    goal:AddSubGoal(GOAL_COMMON_Attack, 10, 3016, TARGET_ENE_0, DIST_None, 0)
    
end

function Griffith_large527100_Act12(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Griffith_large527100_Act13(ai, goal)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
...
function Griffith_large527100_ActAfter_AdjustSpace(ai, goal, paramTbl)
...
function Griffith_large527100Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function Griffith_large527100Battle_Terminate(ai, goal)
    
end

function Griffith_large527100Battle_Interupt(ai, goal)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
    local fate3 = ai:GetRandam_Int(1, 100)
    local targetDist = ai:GetDist(TARGET_ENE_0)
