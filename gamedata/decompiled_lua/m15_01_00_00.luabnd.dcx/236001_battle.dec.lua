...
function OnIf_236001(ai, goal, codeNo)
...
function FourKnightC_Thunder236001Battle_Activate(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function FourKnightC_Thunder236001_Act01(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function FourKnightC_Thunder236001_Act02(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function FourKnightC_Thunder236001_Act03(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    goal:AddSubGoal(GOAL_COMMON_AttackTunableSpin, 10, 3008, TARGET_ENE_0, DIST_Middle, 0, -1)
    
end

function FourKnightC_Thunder236001_Act04(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function FourKnightC_Thunder236001_Act05(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function FourKnightC_Thunder236001_Act06(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function FourKnightC_Thunder236001_Act07(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function FourKnightC_Thunder236001_Act08(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function FourKnightC_Thunder236001_GetWellSpace_Act(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function FourKnightC_Thunder236001Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function FourKnightC_Thunder236001Battle_Terminate(ai, goal)
    
end

function FourKnightC_Thunder236001Battle_Interupt(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
