...
function Husi_Bow250005Battle_Activate(ai, goal)
    local actPerArr = {}
    local actFuncArr = {}
...
function Husi_Bow250005_Act01(ai, goal, paramTbl)
    local FirstAttID = 3000
    local ComAttID = 3001
...
function Husi_Bow250005_Act03(ai, goal, paramTbl)
    local FirstAttID = 3000
    local ComAttID = 3001
...
function Husi_Bow250005Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function Husi_Bow250005Battle_Terminate(ai, goal)
    
end

function Husi_Bow250005Battle_Interupt(ai, goal)
