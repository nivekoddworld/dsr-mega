...
function OnIf_252000(ai, goal, codeNo)
...
function Husi_robber252000Battle_Activate(ai, goal)
    local ObserveNo = 0
...
function Husi_robber252000_Act02(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function Husi_robber252000_Act05(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Husi_robber252000_Act07(ai, goal, paramTbl)
    local fate = ai:GetRandam_Int(1, 100)
    if fate <= 40 then
...
function Husi_robber252000_Act09(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function Husi_robber252000Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function Husi_robber252000Battle_Terminate(ai, goal)
    
end

function Husi_robber252000Battle_Interupt(ai, goal)
    if ai:IsLadderAct(TARGET_SELF) then
        return false
    end
    local fate = ai:GetRandam_Int(1, 100)
