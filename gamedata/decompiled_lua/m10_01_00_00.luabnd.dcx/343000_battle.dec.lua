...
function OnIf_343000(ai, goal, codeNo)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    ai:SetNumber(0, 0)
    
end

function Hellkite343000Battle_Activate(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    ...
    elseif ApproachNearestTimer > 0 then
        ...
        if Dist_NearestPoint <= 1 or not (ai:IsInsideTargetRegion(TARGET_ENE_0, 1012760) or ai:IsInsideTargetRegion(TARGET_ENE_0, 1012761) or ai:IsInsideTargetRegion(TARGET_ENE_0, 1012762) or ai:IsInsideTargetRegion(TARGET_ENE_0, 1012763)) then
            Act12Per = 100
        else
            Act09Per = 100
        end
...
function Hellkite343000_Turn(ai, goal)
    ai:SetEventMoveTarget(1012710)
    local Dist_Self_1012710 = ai:GetDistAtoB(POINT_EVENT, TARGET_SELF)
    local Dist_ENE_1012710 = ai:GetDistAtoB(POINT_EVENT, TARGET_ENE_0)
...
function Hellkite343000Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function Hellkite343000Battle_Terminate(ai, goal)
    
end

function Hellkite343000Battle_Interupt(ai, goal)
    return false
