...
function ArmoredTask346000Battle_Activate(ai, goal)
    ...
    elseif not (ai:IsInsideTargetRegion(TARGET_ENE_0, 1012770) or ai:IsInsideTargetRegion(TARGET_ENE_0, 1012771)) then
        FlagGoHome = 1
        Act09Per = 100
    end
    if FlagGoHome == 0 then
        if ai:IsFinishTimer(0) == true and targetDist >= 12 then
