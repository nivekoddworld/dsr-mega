...
function OnIf_257000(ai, goal, codeNo)
...
function HeavyKnight_Sword257000Battle_Activate(ai, goal)
    local actPerArr = {}
    local actFuncArr = {}
...
function HeavyKnight_Sword257000_Act01(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function HeavyKnight_Sword257000_Act02(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function HeavyKnight_Sword257000_Act03(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function HeavyKnight_Sword257000_Act04(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function HeavyKnight_Sword257000_Act05(ai, goal, paramTbl)
    local fate = ai:GetRandam_Int(1, 100)
...
function HeavyKnight_Sword257000_Act06(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
    local AppDist = Att3007_Dist_max
    local DashDist = Att3007_Dist_max + 2
...
function HeavyKnight_Sword257000_Act07(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function HeavyKnight_Sword257000Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function HeavyKnight_Sword257000Battle_Terminate(ai, goal)
    
end

function HeavyKnight_Sword257000Battle_Interupt(ai, goal)
    local fate = ai:GetRandam_Int(1, 100)
