...
function OnIf_255001(ai, goal, codeNo)
...
function HusiHeavy_Long255001Battle_Activate(ai, goal)
    local actPerArr = {}
    local actFuncArr = {}
    ...
    local f2_local0 = {100, 60, 10, 10, 0, 10, 10}
    local atkAfterFunc = REGIST_FUNC(ai, goal, HumanCommon_ActAfter_AdjustSpace_IncludeSidestep, f2_local0)
    Common_Battle_Activate(ai, goal, actPerArr, actFuncArr, atkAfterFunc, defFuncParamTbl)
    
end

function HusiHeavy_Long255001_Act02(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function HusiHeavy_Long255001_Act05(ai, goal, paramTbl)
    local fate = ai:GetRandam_Int(1, 100)
    if fate <= 40 then
...
function HusiHeavy_Long255001_Act07(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function HusiHeavy_Long255001_Act08(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function HusiHeavy_Long255001Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function HusiHeavy_Long255001Battle_Terminate(ai, goal)
    
end

function HusiHeavy_Long255001Battle_Interupt(ai, goal)
