...
function OnIf_332000(ai, goal, codeNo)
...
function ThreeHaori332000Battle_Activate(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function ThreeHaori332000_ActAfter_AdjustSpace(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
    local fate3 = ai:GetRandam_Int(1, 100)
...
function ThreeHaori332000StepForLeave(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
    local fate3 = ai:GetRandam_Int(1, 100)
...
function ThreeHaori332000Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function ThreeHaori332000Battle_Terminate(ai, goal)
    
end

function ThreeHaori332000Battle_Interupt(ai, goal)
    local fate = ai:GetRandam_Int(1, 100)
