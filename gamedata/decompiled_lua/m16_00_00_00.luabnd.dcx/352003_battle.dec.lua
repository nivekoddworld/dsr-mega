...
function wyvern_on_earth352003Battle_Activate(ai, goal)
...
function wyvern_on_earth352003_Turn(ai, goal)
...
function wyvern_on_earth352003_ActAfter_AdjustSpace(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
    local fate3 = ai:GetRandam_Int(1, 100)
...
function OnIf_352003(ai, goal, codeNo)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
    local fate3 = ai:GetRandam_Int(1, 100)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function wyvern_on_earth352003Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function wyvern_on_earth352003Battle_Terminate(ai, goal)
    
end

function wyvern_on_earth352003Battle_Interupt(ai, goal)
    local fate = ai:GetRandam_Int(1, 100)
    return false
