...
function Ja_yearl_demon539000Battle_Activate(ai, goal)
...
function Ja_yearl_demon539000_Act01(ai, goal)
...
function Ja_yearl_demon539000_Act02(ai, goal)
    local DashFate = ai:GetRandam_Int(1, 100)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Ja_yearl_demon539000_Act03(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Ja_yearl_demon539000_Act04(ai, goal)
    local DashFate = ai:GetRandam_Int(1, 100)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Ja_yearl_demon539000_Act05(ai, goal)
    local DashFate = ai:GetRandam_Int(1, 100)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Ja_yearl_demon539000_Act06(ai, goal)
    local DashFate = ai:GetRandam_Int(1, 100)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Ja_yearl_demon539000_Act07(ai, goal)
    goal:AddSubGoal(GOAL_COMMON_NonspinningAttack, 10, 3008, TARGET_ENE_0, DIST_Middle)
    
end

function Ja_yearl_demon539000_Act08(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Ja_yearl_demon539000_Act09(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fatetime = ai:GetRandam_Int(30, 60)
    ai:SetTimer(0, fatetime)
    goal:AddSubGoal(GOAL_COMMON_KeepDist, 10, TARGET_ENE_0, 15, 22, TARGET_ENE_0, true, -1)
...
function Ja_yearl_demon539000_Act10(ai, goal)
...
function Ja_yearl_demon539000_Act11(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local AppDist = 22
    local DashDist = 32
    local Odds_Guard = 0
...
function Ja_yearl_demon539000_Act12(ai, goal)
    local DashFate = ai:GetRandam_Int(1, 100)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Ja_yearl_demon539000_Act13(ai, goal)
    local DashFate = ai:GetRandam_Int(1, 100)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Ja_yearl_demon539000_Act14(ai, goal)
    local DashFate = ai:GetRandam_Int(1, 100)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Ja_yearl_demon539000_Act15(ai, goal)
    local DashFate = ai:GetRandam_Int(1, 100)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Ja_yearl_demon539000_Act16(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local AppDist = Att3000_Dist_max + 2
    local DashDist = Att3000_Dist_max + 12
    local Odds_Guard = 0
...
function Ja_yearl_demon539000_Act17(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local AppDist = Att3002_Dist_max + 2
    local DashDist = Att3002_Dist_max + 12
    local Odds_Guard = 0
...
function Ja_yearl_demon539000_Act18(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local AppDist = Att3004_Dist_max + 2
    local DashDist = Att3004_Dist_max + 12
    local Odds_Guard = 0
...
function Ja_yearl_demon539000_Act19(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local AppDist = Att3006_Dist_max + 2
    local DashDist = Att3006_Dist_max + 12
    local Odds_Guard = 0
...
function Ja_yearl_demon539000_GetWellSpace_Act(ai, goal)
    local GW_fate = ai:GetRandam_Int(0, 100)
    local bRight = ai:GetRandam_Int(0, 1)
    local friendNum = ai:GetTeamRecordCount(COORDINATE_TYPE_SideWalk_L + bRight, TARGET_ENE_0, 2)
    if GW_fate <= 50 then
...
function Ja_yearl_demon539000Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function Ja_yearl_demon539000Battle_Terminate(ai, goal)
    
end

function Ja_yearl_demon539000Battle_Interupt(ai, goal)
    return false
