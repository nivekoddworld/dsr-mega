...
function Ghost_Male267000Battle_Activate(ai, goal)
...
function Ghost_Male267000_Act02(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function Ghost_Male267000_Act03(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function Ghost_Male267000_Act07(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
    goal:AddSubGoal(GOAL_COMMON_ApproachTarget, 5, TARGET_ENE_0, Att3000_Dist_max, TARGET_SELF, true, 0)
    if fate <= 40 then
...
function Ghost_Male267000_Act08(ai, goal, paramTbl)
...
function Ghost_Male267000Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function Ghost_Male267000Battle_Terminate(ai, goal)
    
end

function Ghost_Male267000Battle_Interupt(ai, goal)
    return false
