...
function wyvern_on_earth352002Battle_Activate(ai, goal)
    ...
    if targetDist >= 4 and targetDist <= 8.2 and (ai:IsInsideTargetRegion(TARGET_SELF, 1602808) and ai:IsInsideTargetRegion(TARGET_ENE_0, 1602808) or ai:IsInsideTargetRegion(TARGET_SELF, 1602808) and ai:IsInsideTargetRegion(TARGET_ENE_0, 1602809) or ai:IsInsideTargetRegion(TARGET_SELF, 1602808) and ai:IsInsideTargetRegion(TARGET_ENE_0, 1602810) or ai:IsInsideTargetRegion(TARGET_SELF, 1602810) and ai:IsInsideTargetRegion(TARGET_ENE_0, 1602808) or ai:IsInsideTargetRegion(TARGET_SELF, 1602810) and ai:IsInsideTargetRegion(TARGET_ENE_0, 1602810) or ai:IsInsideTargetRegion(TARGET_SELF, 1602810) and ai:IsInsideTargetRegion(TARGET_ENE_0, 1602812) or ai:IsInsideTargetRegion(TARGET_SELF, 1602810) and ai:IsInsideTargetRegion(TARGET_ENE_0, 1602814)) then
        Act06Per = 150
    end
    if targetDist >= 0 and targetDist <= 10 and (ai:IsInsideTargetRegion(TARGET_SELF, 1602808) and ai:IsInsideTargetRegion(TARGET_ENE_0, 1602810) or ai:IsInsideTargetRegion(TARGET_SELF, 1602808) and ai:IsInsideTargetRegion(TARGET_ENE_0, 1602815) or ai:IsInsideTargetRegion(TARGET_SELF, 1602815) and ai:IsInsideTargetRegion(TARGET_ENE_0, 1602808)) then
        Act10Per = 150
    end
    if targetDist >= 0 and targetDist <= 6 and canAct11 == 1 then
        Act11Per = 150
    end
    if targetDist >= 0 and targetDist <= 1.5 and (ai:IsInsideTargetRegion(TARGET_SELF, 1602811) or ai:IsInsideTargetRegion(TARGET_SELF, 1602812) or ai:IsInsideTargetRegion(TARGET_SELF, 1602808) or ai:IsInsideTargetRegion(TARGET_SELF, 1602810)) then
        Act09Per = 150
    end
