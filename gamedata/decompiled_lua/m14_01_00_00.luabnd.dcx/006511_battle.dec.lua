REGISTER_GOAL(GOAL_BlackIron_Knight_Enemy6511_Battle, "BlackIron_Knight_Enemy6511Battle")
local NormalR_min = 0
...
local PushR_min = 0
local PushR_max = 1
REGISTER_GOAL_NO_UPDATE(GOAL_BlackIron_Knight_Enemy6511_Battle, 1)

function BlackIron_Knight_Enemy6511Battle_Activate(ai, goal)
    local actPerArr = {}
    local actFuncArr = {}
    ...
    actFuncArr[1] = REGIST_FUNC(ai, goal, BlackIron_Knight_Enemy6511_Act01)
    actFuncArr[2] = REGIST_FUNC(ai, goal, BlackIron_Knight_Enemy6511_Act02)
    actFuncArr[5] = REGIST_FUNC(ai, goal, BlackIron_Knight_Enemy6511_Act05)
    actFuncArr[7] = REGIST_FUNC(ai, goal, BlackIron_Knight_Enemy6511_Act07)
    actFuncArr[9] = REGIST_FUNC(ai, goal, BlackIron_Knight_Enemy6511_Act09)
    actFuncArr[10] = REGIST_FUNC(ai, goal, BlackIron_Knight_Enemy6511_Act10)
    actFuncArr[13] = REGIST_FUNC(ai, goal, BlackIron_Knight_Enemy6511_Act13)
    actFuncArr[15] = REGIST_FUNC(ai, goal, BlackIron_Knight_Enemy6511_Act15)
    actFuncArr[17] = REGIST_FUNC(ai, goal, BlackIron_Knight_Enemy6511_Act17)
    actFuncArr[20] = REGIST_FUNC(ai, goal, BlackIron_Knight_Enemy6511_Act20)
    local atkAfterFunc = REGIST_FUNC(ai, goal, BlackIron_Knight_Enemy6511_ActAfter_AdjustSpace, atkAfterOddsTbl)
    Common_Battle_Activate(ai, goal, actPerArr, actFuncArr, atkAfterFunc, defFuncParamTbl)
    
end

function BlackIron_Knight_Enemy6511_Act01(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function BlackIron_Knight_Enemy6511_Act02(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
    NPC_KATATE_Switch(ai, goal)
    CommonNPC_ChangeWepR1(ai, goal)
...
function BlackIron_Knight_Enemy6511_Act05(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
    NPC_KATATE_Switch(ai, goal)
    CommonNPC_ChangeWepR1(ai, goal)
...
function BlackIron_Knight_Enemy6511_Act07(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
    NPC_KATATE_Switch(ai, goal)
    CommonNPC_ChangeWepR1(ai, goal)
...
function BlackIron_Knight_Enemy6511_Act09(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
    CommonNPC_ChangeWepR1(ai, goal)
...
function BlackIron_Knight_Enemy6511_Act10(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
    CommonNPC_ChangeWepR1(ai, goal)
    NPC_RYOUTE_Switch(ai, goal)
...
function BlackIron_Knight_Enemy6511_Act13(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
    CommonNPC_ChangeWepR1(ai, goal)
    NPC_RYOUTE_Switch(ai, goal)
...
function BlackIron_Knight_Enemy6511_Act15(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
    CommonNPC_ChangeWepR1(ai, goal)
    NPC_RYOUTE_Switch(ai, goal)
...
function BlackIron_Knight_Enemy6511_Act17(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function BlackIron_Knight_Enemy6511_Act20(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function BlackIron_Knight_Enemy6511_ActAfter_AdjustSpace(ai, goal, paramTbl)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
    local MoveDist = 3
    if fate <= 100 then
...
function BlackIron_Knight_Enemy6511Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function BlackIron_Knight_Enemy6511Battle_Terminate(ai, goal)
    
end

function BlackIron_Knight_Enemy6511Battle_Interupt(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
