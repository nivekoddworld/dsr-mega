...
function mukade520000Battle_Activate(ai, goal)
    ...
    if arm1DmgLv == PARTS_DMG_NONE then
        if hprate <= 0.5 and targetDist >= -5 and targetDist <= 2 and fate2 <= 60 then
            Act05Per = 100
        elseif hprate <= 0.5 and targetDist >= 16 and targetDist <= 25 and ai:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_F, 240) and fate3 <= 60 then
            Act07Per = 100
        elseif targetDist >= 2.4 and targetDist <= 7 and ai:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_F, 30) and fate4 <= 60 then
            Act10Per = 100
        elseif targetDist >= -2 and targetDist <= 7 and ai:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_B, 20) and fate5 <= 80 then
            Act04Per = 100
        elseif targetDist >= -2 and targetDist <= 7 and ai:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_L, 120) and ai:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_B, 90) and fate5 <= 80 then
            Act04Per = 100
        ...
        elseif targetDist <= 1 and fate7 <= 50 then
            Act11Per = 100
        elseif targetDist >= 4.5 and targetDist <= 8 and ai:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_F, 40) and fate8 <= 50 then
            Act01Per = 100
        elseif targetDist >= 10 and targetDist <= 16 and ai:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_F, 40) and fate9 <= 50 then
            Act02Per = 100
        elseif targetDist >= 7 and targetDist <= 13 and ai:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_F, 120) and fate10 <= 50 then
            Act03Per = 100
        elseif targetDist >= 4 and targetDist <= 6.5 and ai:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_F, 40) and fate11 <= 35 then
            Act06Per = 100
    ...
    elseif hprate <= 0.5 and targetDist >= 12 and targetDist <= 20 and ai:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_F, 240) and fate2 <= 35 then
        Act15Per = 100
    elseif targetDist >= 2.4 and targetDist <= 7 and ai:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_F, 30) and fate3 <= 35 then
        Act10Per = 100
    elseif targetDist >= -2 and targetDist <= 7 and ai:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_B, 20) and fate4 <= 45 then
        Act04Per = 100
    elseif targetDist >= -2 and targetDist <= 7 and ai:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_L, 120) and ai:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_B, 90) and fate4 <= 45 then
        Act04Per = 100
