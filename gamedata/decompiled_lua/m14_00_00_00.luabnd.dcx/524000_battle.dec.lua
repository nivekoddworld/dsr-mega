...
function PrinceIzalis524000Battle_Activate(ai, goal)
...
function PrinceIzalis524000Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function PrinceIzalis524000Battle_Terminate(ai, goal)
    
end

function PrinceIzalis524000Battle_Interupt(ai, goal)
    return false
