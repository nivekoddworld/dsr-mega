REGISTER_GOAL(GOAL_Ghoul_Human206002_Battle, "Ghoul_Human206002Battle")
local Att3000_Dist_min = 0
local Att3000_Dist_max = 2.2
local Att3001_Dist_min = 0
local Att3001_Dist_max = 2.6
local Att3002_Dist_min = 0
local Att3002_Dist_max = 3.1
...
REGISTER_GOAL_NO_UPDATE(GOAL_Ghoul_Human206002_Battle, 1)

function Ghoul_Human206002Battle_Activate(ai, goal)
    local actPerArr = {}
    local actFuncArr = {}
    ...
    actFuncArr[5] = REGIST_FUNC(ai, goal, Ghoul_Human206002_Act05)
    actFuncArr[6] = REGIST_FUNC(ai, goal, Ghoul_Human206002_Act06)
    actFuncArr[8] = REGIST_FUNC(ai, goal, Ghoul_Human206002_Act08)
    actFuncArr[10] = REGIST_FUNC(ai, goal, Ghoul_Human206002_Act10)
    local f1_local0 = {0, 60, 10, 10, 10, 6, 4}
    local atkAfterFunc = REGIST_FUNC(ai, goal, HumanCommon_ActAfter_AdjustSpace_IncludeSidestep, f1_local0)
    Common_Battle_Activate(ai, goal, actPerArr, actFuncArr, atkAfterFunc, defFuncParamTbl)
    
end

function Ghoul_Human206002_Act05(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Ghoul_Human206002_Act06(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function Ghoul_Human206002_Act08(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function Ghoul_Human206002_Act10(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function Ghoul_Human206002Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function Ghoul_Human206002Battle_Terminate(ai, goal)
    
end

function Ghoul_Human206002Battle_Interupt(ai, goal)
    ...
    if ai:IsFinishTimer(0) == true then
        ai:SetTimer(0, 2)
        local intodds = ai:GetRandam_Int(1, 100)
    end
