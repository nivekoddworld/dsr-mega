...
function CragSpider528000Battle_Activate(ai, goal)
...
function CragSpider528000_Act00(ai, goal)
...
function CragSpider528000_Act01(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local targetDistY = ai:GetDistYSigned(TARGET_ENE_0)
...
function CragSpider528000_Act05(ai, goal)
...
function CragSpider528000_Act11(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local targetDistY = ai:GetDistYSigned(TARGET_ENE_0)
    if targetDistY >= 0.2 then
...
function CragSpider528000_GetWellSpace_Act(ai, goal)
    local fate = ai:GetRandam_Int(1, 100)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    if fate <= 40 then
...
function CragSpider528000Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function CragSpider528000Battle_Terminate(ai, goal)
    
end

function CragSpider528000Battle_Interupt(ai, goal)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
    local fate3 = ai:GetRandam_Int(1, 100)
    local targetDist = ai:GetDist(TARGET_ENE_0)
