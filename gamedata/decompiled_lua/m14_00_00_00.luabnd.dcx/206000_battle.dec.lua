REGISTER_GOAL(GOAL_Ghoul_Sword206000_Battle, "Ghoul_Sword206000Battle")
...
REGISTER_GOAL_NO_UPDATE(GOAL_Ghoul_Sword206000_Battle, 1)

function Ghoul_Sword206000Battle_Activate(ai, goal)
    local actPerArr = {}
    local actFuncArr = {}
    ...
    actFuncArr[5] = REGIST_FUNC(ai, goal, Ghoul_Sword206000_Act05)
    actFuncArr[6] = REGIST_FUNC(ai, goal, Ghoul_Sword206000_Act06)
    actFuncArr[8] = REGIST_FUNC(ai, goal, Ghoul_Sword206000_Act08)
    actFuncArr[10] = REGIST_FUNC(ai, goal, Ghoul_Sword206000_Act10)
...
function Ghoul_Sword206000_Act05(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Ghoul_Sword206000_Act06(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function Ghoul_Sword206000_Act08(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function Ghoul_Sword206000_Act10(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function Ghoul_Sword206000Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function Ghoul_Sword206000Battle_Terminate(ai, goal)
    
end

function Ghoul_Sword206000Battle_Interupt(ai, goal)
