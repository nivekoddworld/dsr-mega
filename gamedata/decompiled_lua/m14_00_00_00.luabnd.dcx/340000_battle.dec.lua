...
function KuraguSpider_Child340000Battle_Activate(ai, goal)
...
function KuraguSpider_Child340000_Act01(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function KuraguSpider_Child340000_Act02(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function KuraguSpider_Child340000_Act03(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function KuraguSpider_Child340000_Act04(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function KuraguSpider_Child340000_Act05(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function KuraguSpider_Child340000_ActAfter_AdjustSpace(ai, goal, paramTbl)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
    if fate <= 20 then
        if fate2 <= 33 then
...
function KuraguSpider_Child340000Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function KuraguSpider_Child340000Battle_Terminate(ai, goal)
    
end

function KuraguSpider_Child340000Battle_Interupt(ai, goal)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
