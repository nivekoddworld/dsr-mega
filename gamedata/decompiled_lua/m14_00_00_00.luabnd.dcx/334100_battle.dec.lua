...
function FlameDog334100Battle_Activate(ai, goal)
    local actPerArr = {}
    local actFuncArr = {}
...
function FlameDog334100_Act01(ai, goal)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
...
function FlameDog334100_Act02(ai, goal)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
    local bRight = ai:GetRandam_Int(0, 1)
    local RTime = ai:GetRandam_Int(0.7, 1.7)
...
function FlameDog334100_Act03(ai, goal)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function FlameDog334100_Act04(ai, goal)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
    if fate <= 50 then
...
function FlameDog334100_ActAfter_AdjustSpace(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
    if fate <= 30 then
...
function FlameDog334100Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function FlameDog334100Battle_Terminate(ai, goal)
    
end

function FlameDog334100Battle_Interupt(ai, goal)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
    local fate3 = ai:GetRandam_Int(1, 100)
    local targetDist = ai:GetDist(TARGET_ENE_0)
