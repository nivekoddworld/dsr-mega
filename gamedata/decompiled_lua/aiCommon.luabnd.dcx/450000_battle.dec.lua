...
function OnIf_450000(ai, goal, codeNo)
    if codeNo == 2 then
...
function TheAbyss450000Battle_Activate(ai, goal)
    local actPerArr = {}
    local actFuncArr = {}
...
function TheAbyss450000_Act01(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function TheAbyss450000_Act02(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function TheAbyss450000_Act03(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function TheAbyss450000_Act04(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function TheAbyss450000_Act05(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function TheAbyss450000_Act06(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function TheAbyss450000_Act07(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function TheAbyss450000_Act08(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function TheAbyss450000_Act09(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function TheAbyss450000_Act10(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function TheAbyss450000_Act11(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function TheAbyss450000_Act14(ai, goal, paramTbl)
...
function TheAbyss450000_Act15(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function TheAbyss450000_Act16(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function TheAbyss450000_Act17(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function TheAbyss450000_Act20(ai, goal, paramTbl)
...
function TheAbyss450000_ActAfter(ai, goal)
...
function TheAbyss450000_ActAfter_AdjustSpace(ai, goal, paramTbl)
    goal:AddSubGoal(GOAL_COMMON_If, 10, 2)
    
end

function TheAbyss450000Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function TheAbyss450000Battle_Terminate(ai, goal)
    
end

function TheAbyss450000Battle_Interupt(ai, goal)
    local fate = ai:GetRandam_Int(1, 100)
    local fate2 = ai:GetRandam_Int(1, 100)
    local fate3 = ai:GetRandam_Int(1, 100)
    local targetDist = ai:GetDist(TARGET_ENE_0)
