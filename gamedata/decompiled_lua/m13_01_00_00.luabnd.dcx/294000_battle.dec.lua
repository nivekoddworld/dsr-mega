...
function OnIf_294000(ai, goal, codeNo)
...
function Skeleton_baby294000Battle_Activate(ai, goal)
...
function Skeleton_baby294000Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function Skeleton_baby294000Battle_Terminate(ai, goal)
    
end

function Skeleton_baby294000Battle_Interupt(ai, goal)
