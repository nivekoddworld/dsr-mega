...
function Hammer_m11_225001Battle_Activate(ai, goal)
...
function Hammer225001_Act01(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function Hammer225001_Act02(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function Hammer225001_Act03(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function Hammer225001_Act04(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function Hammer225001_Act05(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function Hammer225001_Act06(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function Hammer225001_Act07(ai, goal)
...
function Hammer225001_GetWellSpace_Act(ai, goal)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function Hammer_m11_225001Battle_Update(ai, goal)
    return GOAL_RESULT_Continue
    
end

function Hammer_m11_225001Battle_Terminate(ai, goal)
    
end

function Hammer_m11_225001Battle_Interupt(ai, goal)
