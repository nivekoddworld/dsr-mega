...
function MiniGreaterDemon223200_Act01(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
...
function MiniGreaterDemon223200_Act02(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function MiniGreaterDemon223200_Act03(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function MiniGreaterDemon223200_Act04(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function MiniGreaterDemon223200_Act05(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function MiniGreaterDemon223200_Act06(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function MiniGreaterDemon223200_Act07(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function MiniGreaterDemon223200_Act08(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function MiniGreaterDemon223200_Act09(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function MiniGreaterDemon223200_Act10(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function MiniGreaterDemon223200_Act11(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
...
function MiniGreaterDemon223200_Act12(ai, goal, paramTbl)
...
function MiniGreaterDemon223200_Act13(ai, goal, paramTbl)
...
function MiniGreaterDemon223200_Act14(ai, goal, paramTbl)
...
function MiniGreaterDemon223200_Act15(ai, goal, paramTbl)
    goal:AddSubGoal(GOAL_COMMON_NonspinningAttack, 10, 3023, TARGET_ENE_0, DIST_Middle)
    GetWellSpace_Odds = 0
    
end

function MiniGreaterDemon223200_Act16(ai, goal, paramTbl)
...
function MiniGreaterDemon223200_ActAfter_AdjustSpace(ai, goal, paramTbl)
    local targetDist = ai:GetDist(TARGET_ENE_0)
    local fate = ai:GetRandam_Int(1, 100)
