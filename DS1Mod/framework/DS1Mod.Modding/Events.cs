...
public enum TargetEntityType  : short { Object=0, Area=1, Character=2 }
public enum ReactionType      : byte  { HollowAndHuman=48, All=255 }
...
public static class Instr
{
    ...
    // ── action button conditions (3:5, 3:13, 3:18, 3:19; 1:9) ────────────────

    /// <summary>3:5 — IF player presses the action button near <paramref name="entityId"/>.</summary>
    public static EMEVD.Instruction IfActionButton(sbyte condGroup, TargetEntityType entityType,
        short entityId, sbyte angleRad, float dummypolyId, sbyte reactionDist,
        short helpMessageId, ReactionType reactionType = ReactionType.All, short padId = 0) =>
        new(3, 5, new List<object> { condGroup, (short)entityType, entityId, angleRad,
            dummypolyId, reactionDist, helpMessageId, (byte)reactionType, padId });

    /// <summary>3:13 — IF player presses action button near a boss fog gate entity.</summary>
    public static EMEVD.Instruction IfActionButtonBossFog(sbyte condGroup, TargetEntityType entityType,
        short entityId, sbyte angleRad, float dummypolyId, sbyte reactionDist,
        short helpMessageId, ReactionType reactionType = ReactionType.All, short padId = 0) =>
        new(3, 13, new List<object> { condGroup, (short)entityType, entityId, angleRad,
            dummypolyId, reactionDist, helpMessageId, (byte)reactionType, padId });

    /// <summary>3:18 — IF player presses action button within a line-segment region.</summary>
    public static EMEVD.Instruction IfActionButtonLineSegment(sbyte condGroup, TargetEntityType entityType,
        short entityId, sbyte angleRad, float dummypolyId, sbyte reactionDist,
        short helpMessageId, ReactionType reactionType, short padId, short lineSegmentEntityId) =>
        new(3, 18, new List<object> { condGroup, (short)entityType, entityId, angleRad,
            dummypolyId, reactionDist, helpMessageId, (byte)reactionType, padId, lineSegmentEntityId });

    /// <summary>3:19 — IF player presses action button in a line-segment boss room.</summary>
    public static EMEVD.Instruction IfActionButtonLineSegmentBossRoom(sbyte condGroup, TargetEntityType entityType,
        short entityId, sbyte angleRad, float dummypolyId, sbyte reactionDist,
        short helpMessageId, ReactionType reactionType, short padId, short lineSegmentEntityId) =>
        new(3, 19, new List<object> { condGroup, (short)entityType, entityId, angleRad,
            dummypolyId, reactionDist, helpMessageId, (byte)reactionType, padId, lineSegmentEntityId });

    /// <summary>1:9 — IF player presses action button (simple form tied to event flag).</summary>
    public static EMEVD.Instruction IfActionButtonSimple(TargetEntityType entityType,
        short entityId, short angleRad, short dummypolyId, sbyte reactionDist,
        short helpMessageId, uint reactionType, short eventFlagId) =>
        new(1, 9, new List<object> { (short)entityType, entityId, angleRad, dummypolyId,
            reactionDist, helpMessageId, reactionType, eventFlagId });
...
public sealed class SubConditionBuilder
{
    ...
    public SubConditionBuilder ActionButton(TargetEntityType entityType, short entityId,
        sbyte angleRad = 30, float dummypoly = 0, sbyte reactionDist = 2,
        short helpMessageId = 0, ReactionType reactionType = ReactionType.All)
    { _parent.Add(Instr.IfActionButton(_group, entityType, entityId, angleRad,
        dummypoly, reactionDist, helpMessageId, reactionType)); return this; }
...
public sealed class EventBuilder
{
    ...
    /// <summary>Block until the player presses the action button near <paramref name="entityId"/>.</summary>
    public EventBuilder WhenActionButton(TargetEntityType entityType, short entityId,
        sbyte angleRad = 30, float dummypoly = 0, sbyte reactionDist = 2,
        short helpMessageId = 0, ReactionType reactionType = ReactionType.All)
    {
        _instrs.Add(Instr.IfActionButton(condGroup: 0, entityType, entityId,
            angleRad, dummypoly, reactionDist, helpMessageId, reactionType));
        return this;
    }
