...
/// Replacements use their own NpcParam so model-specific attack animations work.
...
public class BossRandomizer
{
    public List<EnemyPlacement> Randomize(
        ...
        Random rng,
        Config.BossOverrideConfig? overrides = null)
    {
        ...
        Config.BossOverrideConfig? overrides)
    {
        ...
        if (unassigned.Count == 0)
            return assignment.Cast<string>().ToList();
